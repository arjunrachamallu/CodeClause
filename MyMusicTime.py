...
frameCnt = 4  # Update this with the correct number of frames in your GIF
frames = [PhotoImage(file='music2.gif', format='gif -index %i' % i) for i in range(frameCnt)]
